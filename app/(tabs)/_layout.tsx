...
export default function TabLayout() {
  ...
  return (
    <Tabs tabBar={() => <CustomTabBar />} screenOptions={{ headerShown: true }}>
      ...
      <Tabs.Screen name="halwa" options={{ title: t("titleHalwa"), header: () => <LogoHeader titleKey={t("titleHalwa")} accentColor={Colors.halwa} /> }} />
      <Tabs.Screen name="mawali" options={{ title: t("titleMawali"), header: () => <LogoHeader titleKey={t("titleMawali")} accentColor={Colors.mawali} /> }} />
      <Tabs.Screen name="chocolate" options={{ title: t("titleChocolate"), header: () => <LogoHeader titleKey={t("titleChocolate")} accentColor={Colors.chocolate} /> }} />
      <Tabs.Screen name="cake" options={{ title: t("titleCake"), header: () => <LogoHeader titleKey={t("titleCake")} accentColor={Colors.cake} /> }} />
      ...
      <Tabs.Screen name="admin" options={{ title: t("titleAdmin"), header: () => <LogoHeader titleKey={t("titleAdmin")} accentColor={Colors.primaryLight} /> }} />
